...
In the WAP-WSP Packet Counter menu the user can check the Packet Counter window. It shows the total packets and they are divided into different Status Codes and PDU Types. The user can filter, copy or save the data into a file.
