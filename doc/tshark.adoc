...
packets. This differs from *-c*<capture packet count> when reading from one
file to write to another.
--
...
This differs from *-a packets:*<capture packet count> when reading
from one file to write to another.
--
