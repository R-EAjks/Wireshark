...
Do not use hidden parameter *--log-level=* and other hidden *--log-...* parameters with extcaps when run from wireshark/tshark. It routes some messages to STDERR and it confuses calling application.
